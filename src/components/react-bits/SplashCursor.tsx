...
export default function SplashCursor({
  ...
  return (
    <div className="pointer-events-none fixed top-0 left-0 z-90 h-full w-full will-change-transform">
      <canvas
        ref={canvasRef}
        id="fluid"
        className="block h-screen w-screen transform-gpu will-change-transform"
      ></canvas>
    </div>
  );
}
