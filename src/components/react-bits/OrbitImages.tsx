...
interface OrbitImagesProps {
  ...
  duration?: number;
  itemSize?: number;
  items?: ReactNode[]; // Allow passing custom nodes
...
// ... (omitted helper functions to ensure correct replacement context, actually wait, context window is small?)
// I will just replace the Props interface and the function signature/destructuring.
// The initial request was for L1-L414 so I have the whole file in context.
...
export default function OrbitImages({
  images = [],
  items: customItems, // Destructure custom items
