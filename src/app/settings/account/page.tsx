      ...
      <main style={{ minHeight: "100vh", padding: "100px 24px 60px", maxWidth: 1000, margin: "0 auto" }}>
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <p style={{ color: "var(--text-secondary)", fontSize: 16, marginBottom: 32 }}>
            Manage your profile, connected accounts, and privacy settings.
          </p>
        </motion.div>
        ...
        >
          <h2 style={{ fontSize: 20, fontWeight: 600, marginBottom: 16 }}>Profile Details</h2>
          <p style={{ color: "var(--text-tertiary)", fontSize: 15 }}>
            Account management tools will go here...
          </p>
        </motion.div>
      </main>
      <PageMountSignaler />
